...
func ModPath() string {
	...
	if path, err := ModuleVersion("github.com/neo532/apitool"); err == nil {
		// $GOPATH/pkg/mod/github.com/neo532/apitool@v2
		return filepath.Join(cachePath, path)
	}
	// $GOPATH/src/github.com/neo532/apitool
	return filepath.Join(gopath, "src", "github.com", "neo532", "apitool")
}
