...
var CmdServer = &cobra.Command{
	...
	Long:  "Generate the proto server code. Example: apitool server helloworld.proto",
	Run:   run,
}
...
func init() {
	if protoPath = os.Getenv("APITOOL_PROTO_PATH"); protoPath == "" {
		protoPath = "./third_party"
	}
	CmdServer.Flags().StringVarP(&protoPath, "proto_path", "p", protoPath, "proto path")
}
