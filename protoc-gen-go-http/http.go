...
// generateFile generates a _http.pb.go file containing apitool errors definitions.
func generateFile(gen *protogen.Plugin, file *protogen.File, omitempty bool) *protogen.GeneratedFile {
	...
	g.P("// versions:")
	//g.P(fmt.Sprintf("// protoc-gen-go-http %s", apitool.Release))
	g.P()
...
// generateFileContent generates the apitool errors definitions, excluding the package statement.
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, omitempty bool) {
	...
	//g.P("// is compatible with the apitool package it is being compiled against.")
